...
const greetings = {
  friendly: [
  "Hello there! I am EVE! I must let you know, I am still in Alpha testing! So my responses are currently scripted.",
  "Good day to you, Friend! I must let you know, I am still in Alpha testing! So my responses are currently scripted."],

  suspicious: [
  "I would introduce myself, but I'm not so sure thats a good idea. I must let you know, I am still in Alpha testing! So my responses are currently scripted.",
  "Hello, how are you? Wait, don't answer that, I have no way of verifying your response! I must let you know, I am still in Alpha testing! So my responses are currently scripted."],

  boastful: [
  "Hey! I am EVE! I am so excited to be talking to you! I must let you know, I am still in Alpha testing! So my responses are currently scripted.",
  "Good day to you. Though I must say that I am having a GREAT day! Beofre I forget, I must let you know that I am still in Alpha testing! So my responses are currently scripted."] };
