...
var myWindowFade = document.getElementById('start-window-fade'),
        ...
        function showTimer() {
            ...
            myDiv.textContent =  month + '/' + day + '/' + year;
        }
        showTimer();
        var d = new Date();
        var days = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
        document.getElementById("day").innerHTML = days[d.getDay()];
        document.getElementById("number-day").innerHTML = d.getDate();
        ...
        document.getElementById('close-all').onclick = function() {
            ...
            if (evetubeOverlay.style.transform == "scale(1)") {
                evetubeOverlay.style.transform = "scale(0)";
                document.getElementById('a1').style.borderBottom = '2px solid #76b9ed';
            }
            if (evebookOverlay.style.transform == "scale(1)") {
                evetubeOverlay.style.transform = "scale(0)";
                document.getElementById('a1').style.borderBottom = '2px solid #76b9ed';
            }
            if (evecloudOverlay.style.transform == "scale(1)") {
                evetubeOverlay.style.transform = "scale(0)";
                document.getElementById('a1').style.borderBottom = '2px solid #76b9ed';
            }
        }
...
var evetubeOverlay = document.getElementById('overlay-evetube');

function opentube() {
    evetubeOverlay.style.transform = "scale(1)";
    document.getElementById('a1').style.display = "block";
}
...
var div = document.getElementById('overlay-evetube'),
    mouseclick = document.getElementById('first-row-win');
...
function returntube() {
   ...
   var evebookOverlay = document.getElementById('overlay-evebook');

   function openbook() {
       evebookOverlay.style.transform = "scale(1)";
       document.getElementById('a1').style.display = "block";
   }

   function closebook() {
        evebookOverlay.style.transform = "scale(0)";
       document.getElementById('a1').style.display = "none";
   }
   ...
   var div = document.getElementById('overlay-evebook'),
       mouseclick = document.getElementById('first-row-win');
   ...
   function returnbook() {
      ...
      var evecloudOverlay = document.getElementById('overlay-evecloud');

      function opencloud() {
        evecloudOverlay.style.transform = "scale(1)";
          document.getElementById('a1').style.display = "block";
      }
  
      function closecloud() {
        evecloudOverlay.style.transform = "scale(0)";
          document.getElementById('a1').style.display = "none";
      }
  
      function closeopencloud() {
        evecloudOverlay.style.transform = "scale(0)";
          document.getElementById('a1').style.display = "block";
          document.getElementById('a1').style.borderBottom = '2px solid #76b9ed';
      }
      ...
      var div = document.getElementById('overlay-evecloud'),
          mouseclick = document.getElementById('first-row-win');
